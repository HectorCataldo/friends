class AmigosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @amigo.save
        format.html { redirect_to amigo_url(@amigo), notice: "Amigo ingresado exitosamente." }
  ...
  def update
    respond_to do |format|
      if @amigo.update(amigo_params)
        format.html { redirect_to amigo_url(@amigo), notice: "Amigo actualizado exitosamente." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to amigos_url, notice: "Amigo fue removido correctamente." }
  ...
  private
    ...
    def amigo_params
      params.require(:amigo).permit(:first_name, :string, :last_name, :email, :phone, :twitter)
    end
end
